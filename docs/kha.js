...
Main.main = function() {
	kha_System.init({ title : "jasper-example", width : 800, height : 600},function() {
		...
		var solver = this1;
		var $window = new Rectangle(-12303292);
		var constraint = jasper__$Variable_Variable_$Impl_$.equalsValue($window.x,10);
		solver.addConstraint(constraint);
		var constraint1 = jasper__$Variable_Variable_$Impl_$.equalsValue($window.y,10);
		solver.addConstraint(constraint1);
		var constraint2 = jasper__$Constraint_Constraint_$Impl_$.modifyStrength(jasper__$Variable_Variable_$Impl_$.equalsValue($window.width,width - 20),1);
		solver.addConstraint(constraint2);
		var constraint3 = jasper__$Constraint_Constraint_$Impl_$.modifyStrength(jasper__$Variable_Variable_$Impl_$.equalsValue($window.height,height - 20),1);
		solver.addConstraint(constraint3);
		var constraint4 = jasper__$Constraint_Constraint_$Impl_$.modifyStrength(jasper__$Variable_Variable_$Impl_$.lteValue($window.width,width - 20),1001001000);
		solver.addConstraint(constraint4);
		var constraint5 = jasper__$Constraint_Constraint_$Impl_$.modifyStrength(jasper__$Variable_Variable_$Impl_$.lteValue($window.height,height - 20),1001001000);
		solver.addConstraint(constraint5);
		var constraint6 = jasper__$Constraint_Constraint_$Impl_$.modifyStrength(jasper__$Variable_Variable_$Impl_$.gteValue($window.width,50),1001001000);
		solver.addConstraint(constraint6);
		var constraint7 = jasper__$Constraint_Constraint_$Impl_$.modifyStrength(jasper__$Variable_Variable_$Impl_$.gteValue($window.height,50),1001001000);
		solver.addConstraint(constraint7);
		var leftChild = new Rectangle(-5592406);
		var _g = leftChild.x;
		var _g1 = jasper__$Variable_Variable_$Impl_$.addValue($window.x,10);
		var constraint8 = jasper__$Expression_Expression_$Impl_$.equalsVariable(_g1,_g);
		solver.addConstraint(constraint8);
		var _g2 = leftChild.y;
		var _g3 = jasper__$Variable_Variable_$Impl_$.addValue($window.y,10);
		var constraint9 = jasper__$Expression_Expression_$Impl_$.equalsVariable(_g3,_g2);
		solver.addConstraint(constraint9);
		var _g4 = leftChild.width;
		var _g5 = jasper__$Term_Term_$Impl_$.subtractValue(jasper__$Variable_Variable_$Impl_$.divideValue($window.width,2),20);
		var constraint10 = jasper__$Expression_Expression_$Impl_$.equalsVariable(_g5,_g4);
		solver.addConstraint(constraint10);
		var _g6 = leftChild.height;
		var _g7 = jasper__$Variable_Variable_$Impl_$.subtractValue($window.height,20);
		var constraint11 = jasper__$Expression_Expression_$Impl_$.equalsVariable(_g7,_g6);
		solver.addConstraint(constraint11);
		var rightChild = new Rectangle(-2236963);
		var _g8 = rightChild.x;
		var _g9 = jasper__$Expression_Expression_$Impl_$.subtractExpression(jasper__$Variable_Variable_$Impl_$.addVariable($window.x,$window.width),jasper__$Term_Term_$Impl_$.subtractValue(jasper__$Variable_Variable_$Impl_$.divideValue($window.width,2),10));
		var constraint12 = jasper__$Expression_Expression_$Impl_$.equalsVariable(_g9,_g8);
		solver.addConstraint(constraint12);
		var _g10 = rightChild.y;
		var _g11 = jasper__$Variable_Variable_$Impl_$.addValue($window.y,10);
		var constraint13 = jasper__$Expression_Expression_$Impl_$.equalsVariable(_g11,_g10);
		solver.addConstraint(constraint13);
		var _g12 = rightChild.width;
		var _g13 = jasper__$Term_Term_$Impl_$.subtractValue(jasper__$Variable_Variable_$Impl_$.divideValue($window.width,2),20);
		var constraint14 = jasper__$Expression_Expression_$Impl_$.equalsVariable(_g13,_g12);
		solver.addConstraint(constraint14);
		var _g14 = rightChild.height;
		var _g15 = jasper__$Variable_Variable_$Impl_$.subtractValue($window.height,20);
		var constraint15 = jasper__$Expression_Expression_$Impl_$.equalsVariable(_g15,_g14);
		solver.addConstraint(constraint15);
		var centerChild = new Rectangle(-256);
		var _g18 = centerChild.x;
		var _g16 = $window.x;
		var _g17 = jasper__$Variable_Variable_$Impl_$.divideValue($window.width,4);
		var _g19 = jasper__$Term_Term_$Impl_$.addVariable(_g17,_g16);
		var constraint16 = jasper__$Expression_Expression_$Impl_$.equalsVariable(_g19,_g18);
		solver.addConstraint(constraint16);
		var _g22 = centerChild.y;
		var _g20 = $window.y;
		var _g21 = jasper__$Variable_Variable_$Impl_$.divideValue($window.height,4);
		var _g23 = jasper__$Term_Term_$Impl_$.addVariable(_g21,_g20);
		var constraint17 = jasper__$Expression_Expression_$Impl_$.equalsVariable(_g23,_g22);
		solver.addConstraint(constraint17);
		var _g24 = centerChild.width;
		var _g25 = jasper__$Variable_Variable_$Impl_$.divideValue($window.width,2);
		var constraint18 = jasper__$Term_Term_$Impl_$.equalsVariable(_g25,_g24);
		solver.addConstraint(constraint18);
		var _g26 = centerChild.height;
		var _g27 = jasper__$Variable_Variable_$Impl_$.divideValue($window.height,2);
		var constraint19 = jasper__$Term_Term_$Impl_$.equalsVariable(_g27,_g26);
		solver.addConstraint(constraint19);
		Main._rectangles = [$window,leftChild,rightChild,centerChild];
		solver.updateVariables();
		solver.addEditVariable($window.width,1000);
		solver.addEditVariable($window.height,1000);
		Main._shouldRender = true;
		...
		kha_input_Mouse.get().notify(function(b,x,y) {
			...
			if(_isDown) {
				solver.suggestValue($window.width,x2 - 10);
				solver.suggestValue($window.height,y2 - 10);
				solver.updateVariables();
				Main._shouldRender = true;
			}
		},function(c) {
...
Main.render = function(framebuffer) {
	if(Main._shouldRender) {
		framebuffer.get_g2().begin(null,-1118482);
		var _g = 0;
		var _g1 = Main._rectangles;
		while(_g < _g1.length) {
			var rectangle = _g1[_g];
			++_g;
			rectangle.render(framebuffer);
		}
		framebuffer.get_g2().end();
	}
	Main._shouldRender = false;
};
var Rectangle = function(color) {
	this.color = color;
...
jasper_SolverImpl.prototype = {
	...
	,removeConstraint: function(constraint) {
		...
		if(this.m_rows._map.exists(tag.marker)) {
	...
	,hasConstraint: function(constraint) {
		return this.m_cns._map.exists(constraint);
	}
	...
	,hasEditVariable: function(variable) {
		return this.m_edits._map.exists(variable);
	}
	...
	,removeMarkerEffects: function(marker,strength) {
		if(this.m_rows._map.exists(marker)) {
